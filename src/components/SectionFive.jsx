...
const SectionFive = () => {
	return (
		<motion.div
			...
			className='min-h-screen flex flex-col items-center py-20 lg:py-32 gap-20 bg-yellow-50' id='sectionFive'>
			<div className='text-4xl font-semibold mb-20 text-azulServe text-center bg-yellow-400 py-6 w-11/12 lg:w-5/12 rounded shadow-lg'>
				<h2>CONTACTO</h2>
			</div>
			<div className='flex flex-col lg:flex-row gap-40 w-11/12 lg:w-7/12 justify-between'>
				<div className='flex flex-col w-full gap-4 text-xl text-blue-900 font-semibold'>
					...
					<a href='mailto:servemastersas@gmail.com' className='flex gap-2'>
						<EnvelopeIcon className="w-8 text-yellow-500" />
						<p className='hover:underline'>construmac@correo.com</p>
					</a>
					<a href='' className='flex gap-2'>
						<MapPinIcon className="w-8 text-yellow-500" />
						<p className='hover:underline'>Calle 27, Tucumán, Argentina</p>
					</a>
					<div href='' className='flex gap-2 items-start'>
						<DevicePhoneMobileIcon className="w-8 text-yellow-500" />
						<div className='flex flex-col gap-2'>
							<a className='hover:underline' href="">+549 1234-567890</a>
							<a className='hover:underline' href="">+549 2345-678901</a>
						</div>
					</div>
				</div>
				...
				<div className='w-full flex justify-center'>
					<form action="" className='flex flex-col w-full max-w-[30rem] gap-6 text-lg'>
						...
						<div className='text-end'>
							<button className='bg-yellow-400 hover:bg-yellow-500 duration-300 text-blue-950 py-2 px-7 rounded-md '>Enviar</button>
						</div>
